...
[x, fs]= audioread('C:\Users\ghy\Desktop\3TB\TUT3\L03_Group8.wav');
...
% We know the sampling rate is _____8000Hz_______________
...
% Reading the FFT we realize that the frequency we want to remove is ____2000Hz_____
% ( Hint : our noise is a pure sine wave )
% Now specify the frequency you want to eliminate by setting :

fkill = 2000/(fs/2);

% Hint : fkill is always in the range of 0 to 1 , and is normalized to frequency of fs /2.
...
% the noise while passing all other signals . Try increasing your filter length until
% you can achieve an adequate result .
...
fid=fopen('C:\Users\ghy\Desktop\3TB\TUT3\audio.txt','w');
...
% The secret code for your group is ________GTAC03_____________
...
audiowrite ('C:\Users\ghy\Desktop\3TB\TUT3\output.wav',y,fs) 
